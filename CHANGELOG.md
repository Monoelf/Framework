...
- Реализовано:
  - доработано построение запросов на использование оффсет, лимит, правильную обработку null и in
  - класс соединения с бд с кешем
  - продюсер кафки
  - в редис добавлены методы работы с подписками и членами

## [ [0.7.0](https://github.com/Monoelf/Framework/tree/0.7.0) ] - 06.02.2026
